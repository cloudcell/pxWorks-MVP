...
namespace NaughtyAttributes.Editor
{
    public static class ReflectionUtility
    {
        ...
        public static MemberInfo GetFieldOrProperty(object target, string fieldName)
        {
            MemberInfo res = GetField(target, fieldName);
            if (res == null)
                res = GetProperty(target, fieldName);
        ...
        {
            return GetMethod(target, methodName)?.Invoke(target, args);
        }
