...
namespace XNodeEditor {
    public partial class NodeEditorWindow {
        ...
        public static event Action<XNode.Node> OnNodeClick;
        public static event Action<XNode.Node> OnNodeHeaderClick;
                ...
                case EventType.MouseDown:
                    ...
                    if (e.button == 0) {
                        ...
                        } else if (IsHoveringNode)
                        {
                            ...
                            {
                                OnNodeClick?.Invoke(hoveredNode);
                            }
                ...
                case EventType.MouseUp:
                    if (e.button == 0) {
                        ...
                        if (IsDraggingPort) {
                            ...
                            if(IsHoveringTitle(hoveredNode))
                                OnNodeHeaderClick?.Invoke(hoveredNode);
                            else
                                OnNodeClick?.Invoke(hoveredNode);
                            return;
                        } else if (!IsHoveringNode) {
