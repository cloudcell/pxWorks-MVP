...
#region Dynamic Ports
        ...
        public bool RenameDynamicPort(NodePort port, string newFieldName)
        {
            if (ports.ContainsKey(newFieldName))
                return false;
            ports.Remove(port.fieldName);
            port.fieldName = newFieldName;
            ports.Add(newFieldName, port);
