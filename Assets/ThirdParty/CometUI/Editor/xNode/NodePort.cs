...
namespace XNode {
    ...
    public class NodePort {
        ...
        [SerializeField] private string _portType;
        ...
        public static Func<NodePort, NodePort, bool> CanBeConnectedTo;
        ...
        public bool CanConnectTo(NodePort port) {
            ...
            if (CanBeConnectedTo != null)
                return CanBeConnectedTo(output, input);
